/*
  ...
  - You are about to drop the column `titre` on the `photo` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `photo` DROP COLUMN `titre`,
    MODIFY `profil` BOOLEAN NOT NULL DEFAULT false;
