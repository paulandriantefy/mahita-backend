/*
  ...
  - You are about to drop the column `Tarif` on the `mission` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `mission` DROP COLUMN `Tarif`,
    ADD COLUMN `tarif` DOUBLE NULL;
