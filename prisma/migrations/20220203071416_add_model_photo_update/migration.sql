/*
  ...
  - Added the required column `profil` to the `Photo` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `photo` ADD COLUMN `profil` BOOLEAN NOT NULL;
